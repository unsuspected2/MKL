    ...
    <div class="scroll-sidebar" data-simplebar>
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="mb-4 pb-2">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link warning-hover-bg" href="{{ route('admin.gestao.clientes') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link danger-hover-bg" href="{{ route('admin.gestao.produtos') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link success-hover-bg" href="{{ route('admin.gestao.fornecedores') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link info-hover-bg" href="{{ route('admin.gestao.vendas') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link primary-hover-bg" href="{{ route('admin.gestao.funcionarios') }}" aria-expanded="false">
                        <span class="aside-icon p-2 bg-light-primary rounded-3">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link warning-hover-bg" href="{{ route('admin.gestao.projetos') }}" aria-expanded="false">
                        <span class="aside-icon p-2 bg-light-warning rounded-3">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link danger-hover-bg" href="{{ route('admin.gestao.financeiro') }}" aria-expanded="false">
                        <span class="aside-icon p-2 bg-light-danger rounded-3">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link success-hover-bg" href="{{ route('admin.gestao.contratos') }}" aria-expanded="false">
                        <span class="aside-icon p-2 bg-light-success rounded-3">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link info-hover-bg" href="{{ route('admin.gestao.ordens-producao') }}" aria-expanded="false">
                        <span class="aside-icon p-2 bg-light-info rounded-3">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link primary-hover-bg" href="{{ route('admin.gestao.impostos') }}" aria-expanded="false">
                        <span class="aside-icon p-2 bg-light-primary rounded-3">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link warning-hover-bg" href="{{ route('admin.gestao.beneficios') }}" aria-expanded="false">
                        <span class="aside-icon p-2 bg-light-warning rounded-3">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link success-hover-bg" href="{{ route('admin.gestao.atividades') }}" aria-expanded="false">
                        <span class="aside-icon p-2 bg-light-success rounded-3">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link info-hover-bg" href="{{ route('profile.edit') }}" aria-expanded="false">
                        <span class="aside-icon p-2 bg-light-info rounded-3">

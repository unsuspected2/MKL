...
<div class="container-fluid">
    <center><h3><strong><b>Financeiro</b></strong></h3></center>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalEdit-{{ $financeiro->id }}">Editar</a>
                                                    <a class="dropdown-item" href="{{ route('admin.gestao.financeiro.apagar', ['id' => $financeiro->id]) }}">Remover</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <div class="modal fade" id="modalEdit-{{ $financeiro->id }}" tabindex="-1" role="dialog" aria-labelledby="modalEditLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="modalEditLabel">Editar Financeiro</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">×</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        @include('admin.financials.edit.index', ['financeiro' => $financeiro])
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

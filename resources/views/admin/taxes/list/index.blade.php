...
<div class="container-fluid">
    <center><h3><strong><b>Impostos</b></strong></h3></center>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalEdit-{{ $imposto->id }}">Editar</a>
                                                    <a class="dropdown-item" href="{{ route('admin.gestao.imposto.apagar', ['id' => $imposto->id]) }}">Remover</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <div class="modal fade" id="modalEdit-{{ $imposto->id }}" tabindex="-1" role="dialog" aria-labelledby="modalEditLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        @include('admin.taxes.edit.index', ['imposto' => $imposto])
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
